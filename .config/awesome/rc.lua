...
-- Local custom theme path
local custom_themes_path = "~/.config/awesome/themes/"
-- Volume widget
...
mytextclock = wibox.widget.textclock('<span color="#ffffff" font="JetBrains Mono 10"> %a %b %d, %H:%M </span>', 5)
-- Connect calendar widget into textclock
...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag({ "1", "2", "3", "4", "5", "6", "󰙯 ", " " }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "space", function()
		awful.util.spawn("rofi -modi drun -show drun -show-icons -width 22", false)
	end, { description = "show the menubar", group = "launcher" }),
	-- Launch Browser
	awful.key({ modkey }, "b", function()
		awful.util.spawn("brave", false)
	end, { description = "Run internet browser", group = "launcher" }),
	-- Launch file manager
